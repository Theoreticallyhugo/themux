...
main()
{
  ...
  show_powerline=$(get_tmux_option "@themux-show-powerline" true)
  show_flags=$(get_tmux_option "@themux-show-flags" false)
  show_left_icon_static=$(get_tmux_option "@themux-show-left-icon-static" "#H | ")
  ...
  show_timezone=$(get_tmux_option "@themux-show-timezone" false)
